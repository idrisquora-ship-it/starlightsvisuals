...
const projects = [
  { poster: portfolioTrailer, video: trailerVid.url, tag: "Cinematic Trailer", title: "Iron Sentinel", desc: "AAA game launch trailer.", span: "lg:col-span-2 lg:row-span-2" },
  { poster: portfolioCharacter, video: characterVid.url, tag: "Character Design", title: "Nova Vanguard", desc: "Hero protagonist sheet." },
  { poster: portfolioGame, video: gameVid.url, tag: "Game Art", title: "Lumen Worlds", desc: "Open-world environment art." },
  { poster: portfolio2d, video: twoDVid.url, tag: "2D Animation", title: "Neon Skyline", desc: "Anime-inspired pilot episode." },
  { poster: portfolioCreature, video: creatureVid.url, tag: "Creature Design", title: "Crystal Wyrm", desc: "Boss creature concept.", span: "lg:col-span-2" },
  { poster: portfolioMotion, video: motionVid.url, tag: "Motion Graphics", title: "Pulse Identity", desc: "Brand motion system." },
];
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative isolate border-b border-border/40">
        ...
        <div className="mx-auto max-w-5xl px-6 py-24 md:py-32 text-center">
          <p className="font-script text-2xl text-neon-green">Selected work</p>
          ...
          {projects.map((p) => (
            ...
            >
              ...
              <div className="absolute top-4 left-4 inline-flex items-center gap-1 rounded-full border border-neon-green/40 bg-background/60 px-3 py-1 backdrop-blur">
                <span className="font-display text-[10px] uppercase tracking-widest text-neon-green">{p.tag}</span>
              </div>
