...
const testimonials: TextTestimonial[] = [
  {
    headline: "True professionals who delivered results",
    quote:
  ...
  {
    headline: "A launch film that felt theatrical",
    quote:
  ...
  {
    headline: "Surgical craft on a global deadline",
    quote:
      ...
      <div className="mx-auto max-w-7xl px-6 py-20 md:px-14 md:py-28">
        <SectionReveal className="mx-auto max-w-4xl text-center">
          ...
          <h2 className="mt-5 font-display text-2xl uppercase leading-tight tracking-tight sm:text-3xl md:text-4xl lg:text-[2.75rem] lg:leading-none">
            <span className="text-foreground">They trusted our work &</span>{" "}
            <span className="neon-text text-glow">Results</span>
          </h2>
        </SectionReveal>
        ...
        >
          <div className="testimonial-carousel -mx-6 flex snap-x snap-mandatory gap-4 overflow-x-auto px-6 pb-4">
            {testimonials.map((t) => (
              <div key={t.name} className="w-[min(92vw,380px)] shrink-0 snap-center">
